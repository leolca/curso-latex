...
%\documentclass[notes,xcolor={table}]{beamer}
\usepackage{tikz}
...
{%
  ...
  \filldraw[white]
    ...
    ;
   \node[opacity=0.2] at ([xshift=-5.2cm,yshift=0.5cm]current page.north east) 
...
\framesubtitle{Utilize a câmera do celular!}
  \begin{figure}[h!]
  \centering
  \includegraphics[width=0.3\textwidth]{figures/qr_img.png}
