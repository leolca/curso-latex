...
\framesubtitle{Código Morse - Samuel Morse e Alfred Vail (1837)}
	...
	\includegraphics[width=0.5\textwidth]{figures/MorseCode.pdf} \hspace{3em}
...
\framesubtitle{Código Murray}
        \includegraphics[width=0.4\textwidth]{figures/murrayapparatus.jpg} 
\end{frame}
...
\includegraphics[width=0.75\textwidth]{figures/USASCII.png}
\end{frame}
\note{
\scriptsize
